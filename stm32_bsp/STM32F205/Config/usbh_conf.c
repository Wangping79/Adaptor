...
void HAL_HCD_MspInit(HCD_HandleTypeDef *hhcd)
{
  ...
  GPIO_InitStruct.Pin = (USB_OTG_HS_DP | USB_OTG_HS_DM); // Pin12, Pin11
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_HIGH;
  GPIO_InitStruct.Alternate = GPIO_AF_OTG_FS;
  HAL_GPIO_Init(USB_OTG_GPIO_Port, &GPIO_InitStruct); 
  
  /* Configure ID pin */
  GPIO_InitStruct.Pin = USB_OTG_HS_ID;                // Pin10
...
{
   HAL_GPIO_DeInit(USB_OTG_GPIO_Port, USB_OTG_HS_DP|USB_OTG_HS_DM|USB_OTG_HS_ID|USB_OTG_HS_VBUS);
   HAL_GPIO_DeInit(VBUS_EN_GPIO_Port, VBUS_EN_Pin);
