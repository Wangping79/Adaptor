...
/* USB CUSTOM_HID device Configuration Descriptor */
__ALIGN_BEGIN uint8_t USBD_CUSTOM_HID_Desc[USB_CUSTOM_HID_DESC_SIZ] __ALIGN_END =
{
  /* 18 */
  0x09,         /*bLength: CUSTOM_HID Descriptor size*/
  CUSTOM_HID_DESCRIPTOR_TYPE, /*bDescriptorType: CUSTOM_HID*/
...
__ALIGN_BEGIN uint8_t USBD_CUSTOM_HID_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC] __ALIGN_END =
{
                               ...
                               uint8_t cfgidx)
{
  ...
  else
  {
    ...
    ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData[CUSTOM_HID_USER_DATA])->Init();
          /* Prepare Out endpoint to receive 1st packet */ 
     //HOLIP:
     memset(hhid->Report_buf, 0xAA, USBD_CUSTOMHID_OUTREPORT_BUF_SIZE);
                                 ...
                                 uint8_t cfgidx)
{
  ...
  if(pdev->pClassData != NULL)
  {
    ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData[CUSTOM_HID_USER_DATA])->DeInit();
                                ...
                                USBD_SetupReqTypedef *req)
{
  ...
  case USB_REQ_TYPE_CLASS :  
    ...
    case CUSTOM_HID_REQ_GET_REPORT:
       ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData[CUSTOM_HID_USER_DATA])->ReportFeature(pdev, req->wLength, req->wValue);
       break;
  ...
  case USB_REQ_TYPE_STANDARD:
    ...
    case USB_REQ_GET_DESCRIPTOR: 
      if( req->wValue >> 8 == CUSTOM_HID_REPORT_DESC)
      {
        ...
        pbuf =  ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData[CUSTOM_HID_USER_DATA])->pReport;
      }
                              ...
                              uint8_t epnum)
{
 ...
 // ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData[CUSTOM_HID_USER_DATA])->OutEvent(hhid->Report_buf[0], 
 //                                                           hhid->Report_buf[1]);
   
   // Holip:2016-11-24
  ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData[CUSTOM_HID_USER_DATA])->OutData(hhid->Report_buf, epnum);
                                             ...
                                             USBD_CUSTOM_HID_ItfTypeDef *fops)
{
  ...
  if(fops != NULL)
  {
    pdev->pUserData[CUSTOM_HID_USER_DATA]= fops;
    ret = USBD_OK;    
  }
