...
#define CUSTOM_HID_EPIN_SIZE                 0x40//Wangping 2016-11-24 0x02

#define CUSTOM_HID_EPOUT_ADDR                0x01
#define CUSTOM_HID_EPOUT_SIZE                0x40//Wangping 2016-11-24 0x02
...
typedef struct _USBD_CUSTOM_HID_Itf
{
  ...
  // Holip:2016-11-24
  int8_t (* OutData)       (uint8_t *pBuf, uint8_t endpoint);
  int8_t (* ReportFeature) (USBD_HandleTypeDef  *pdev, uint8_t length, uint8_t value);
