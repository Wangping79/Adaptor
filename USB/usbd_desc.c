...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x1E46//0// 0x0483
#define USBD_PID                      0x0006//0//0x5750
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "Danfoss Drives"
#define USBD_PRODUCT_HS_STRING        "VLT Midi Drive FC280"
#define USBD_PRODUCT_FS_STRING        "VLT Midi Drive FC280"
#define USBD_SERIAL_HS_STRING         "DD-DB-01"
#define USBD_SERIAL_FS_STRING         "DD-DB-01"
